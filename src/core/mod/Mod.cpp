...
void Mod::Load(
    ...
    LOAD_CATCH(m_ProvinceManager->LoadAdjacencies(*m_TitleManager), LoadingState::ADJACENCIES, "adjacencies", true);
...
void Mod::Export(
    ...
    if (provinceAdjacencies)
        m_ProvinceManager->ExportAdjacencies();
