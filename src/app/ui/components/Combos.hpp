...
namespace Components {
    ...
    /**
     * @brief Renders a combo box for selecting the type of an province adjacency.
     * @param currentType The currently selected type.
     * @param onSelect A callback function that is called when a type is selected.
     * @return `True` if the value was changed, `false` otherwise.
     */
    bool AdjacencyTypeCombo(std::string currentType, std::function<void(std::string)> onSelect);
}